...
is 1 array a rotation of another - return Trur/False
same size and elements but start index is different

BigO(n) we are going through each array 2x but O(2n) = O(n) since in infinite sized lists,
costants mean nothing
...
Getting to last item wothiu a false means true.\
